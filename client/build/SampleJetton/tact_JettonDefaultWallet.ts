import {
    ABIGetter,
    ABIReceiver, ABIType, Address, beginCell, Builder, Cell, Contract,
    ContractABI, contractAddress,
    ContractProvider, DictionaryValue, Sender, Slice, TupleBuilder, TupleReader
} from 'ton-core'
...
export function loadJettonWalletData(slice: Slice) {
    ...
    let _walletCode = sc_0.loadRef();
    return { $$type: 'JettonWalletData' as const, balance: _balance, owner: _owner, parent: _parent, walletCode: _walletCode };
}
...
export function loadJettonDefaultWallet$Data(slice: Slice) {
    ...
    return { $$type: 'JettonDefaultWallet$Data' as const, parent: _parent, owner: _owner, balance: _balance };
}
...
export function loadSampleJetton$Data(slice: Slice) {
    ...
    let _owner = sc_0.loadAddress();
    let _content = sc_0.loadBit() ? sc_0.loadRef() : null;
    return { $$type: 'SampleJetton$Data' as const, totalSupply: _totalSupply, mintable: _mintable, owner: _owner, content: _content };
}
...
async function JettonDefaultWallet_init(parent: Address, owner: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initJettonDefaultWallet_init_args({ $$type: 'JettonDefaultWallet_init_args', parent, owner })(builder);
...
const JettonDefaultWallet_types: ABIType[] = [
    ...
    {"name":"JettonWalletData","header":null,"fields":[{"name":"balance","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"parent","type":{"kind":"simple","type":"address","optional":false}},{"name":"walletCode","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"JettonDefaultWallet$Data","header":null,"fields":[{"name":"parent","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    ...
    {"name":"SampleJetton$Data","header":null,"fields":[{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"mintable","type":{"kind":"simple","type":"bool","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"content","type":{"kind":"simple","type":"cell","optional":true}}]},
]
...
export class JettonDefaultWallet implements Contract {
    ...
    static async init(parent: Address, owner: Address) {
        return await JettonDefaultWallet_init(parent, owner);
    }
    
    static async fromInit(parent: Address, owner: Address) {
        const init = await JettonDefaultWallet_init(parent, owner);
